          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-2">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                <p>• AI-powered voice generation with Eleven Labs</p>
                <p>• Custom background videos and music</p>
                <p>• Professional text animations</p>
                <p>• High-quality video rendering</p>
                <p>• Perfect YouTube Shorts format (9:16)</p>
              </div>
            </div>
          </CardContent>
        </Card>
